...
int Prompt(string message)
{
  ...
  string value = Console.ReadLine();//cчитывает с консоли строку
...
int lenght = Prompt("Введите колличество элементов >");
int[] array;
array = InputArray(lenght);
PrintArray(array);
Console.WriteLine($"Колличество чисел больше нуля - {CountPositiveNumbers(array)}");
